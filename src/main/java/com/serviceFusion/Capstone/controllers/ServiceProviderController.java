...
public class ServiceProviderController {
    ...
    public ResponseEntity<UploadImageResponse> uploadProfilePicture(@Valid @RequestBody ServiceProviderUploadImageRequest request) throws ServiceFusionException, IOException {
